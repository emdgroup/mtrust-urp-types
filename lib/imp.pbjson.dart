...
final $typed_data.Uint8List urpImpPrimeResponseDescriptor = $convert
    .base64Decode('ChNVcnBJbXBQcmltZVJlc3BvbnNlEhAKA2dzYRgBIAEoBVIDZ3Nh');
...
final $typed_data.Uint8List urpImpPrimeParametersDescriptor = $convert.base64Decode(
    'ChVVcnBJbXBQcmltZVBhcmFtZXRlcnMSHwoHcGF5bG9hZBgBIAEoCUIFkj8CcEBSB3BheWxvYW'
    'Q=');
...
final $typed_data.Uint8List urpImpMeasurementDescriptor = $convert.base64Decode(
    ...
    'tlblNuGAYgASgJQgWSPwJwGFIHdG9rZW5TbhIgCgt0b2tlblNjYW5OchgHIAEoDVILdG9rZW5T'
    'Y2FuTnISGgoIdG9rZW5JYXQYCCABKANSCHRva2VuSWF0EhoKCHRva2VuRXhwGAkgASgDUgh0b2'
    'tlbkV4cA==');
