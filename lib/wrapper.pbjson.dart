...
final $typed_data.Uint8List urpResponseDescriptor = $convert.base64Decode(
    'CgtVcnBSZXNwb25zZRIgCgdwYXlsb2FkGAEgASgMQgaSPwMImDBSB3BheWxvYWQ=');
...
final $typed_data.Uint8List urpSignChallengeParametersDescriptor =
...
final $typed_data.Uint8List urpSignChallengeResponseDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List urpLogDescriptor = $convert
    .base64Decode('CgZVcnBMb2cSIAoHbWVzc2FnZRgBIAEoCUIGkj8DcIAEUgdtZXNzYWdl');
  ...
  '2': [
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.UrpSemanticVersion',
      '10': 'version'
    },
    {
      '1': 'minRequiredVersion',
      '3': 8,
      '4': 1,
      '5': 11,
      '6': '.UrpSemanticVersion',
      '10': 'minRequiredVersion'
    },
  ],
};
...
const UrpCoreCommand$json = {
  ...
  '2': [
    ...
    },
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.UrpSetNameParameters',
      '9': 0,
      '10': 'setNameParameters'
    },
    {
      '1': 'apParameters',
      '3': 3,
    ...
    },
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.UrpStartDfuParameters',
      '9': 0,
      '10': 'dfuParameters'
    },
    {
      '1': 'signChallengeParameters',
      '3': 8,
      '4': 1,
      '5': 11,
      '6': '.UrpSignChallengeParameters',
      '9': 0,
      '10': 'signChallengeParameters'
    },
  ],
  '8': [
    {'1': 'parameters'},
...
final $typed_data.Uint8List urpSetNameParametersDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List urpDeviceIdDescriptor = $convert
    .base64Decode('CgtVcnBEZXZpY2VJZBIbCgV2YWx1ZRgBIAEoCUIFkj8CcBRSBXZhbHVl');
...
final $typed_data.Uint8List urpDeviceConfigDescriptor = $convert.base64Decode(
    ...
    '1jbG91ZFByZXNlbmNlEh8KB290YV91cmwYDSABKAlCBpI/A3D/AVIGb3RhVXJsEi4KE2JsZV9w'
    'YWlyaW5nX2VuYWJsZWQYDyABKAhSEWJsZVBhaXJpbmdFbmFibGVk');
...
final $typed_data.Uint8List urpSignedConfigPayloadDescriptor =
    $convert.base64Decode(
