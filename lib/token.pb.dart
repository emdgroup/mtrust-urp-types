...
class UrpToken extends $pb.GeneratedMessage {
  factory UrpToken({
    ...
    $core.int? request,
    $core.int? refund,
    $core.Iterable<UrpTokeCapability>? capabilities,
  }) {
    final $result = create();
    if (sn != null) {
      $result.sn = sn;
  ...
  UrpToken._() : super();
  factory UrpToken.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory UrpToken.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'UrpToken',
    ...
    ..pc<UrpTokeCapability>(
        7, _omitFieldNames ? '' : 'capabilities', $pb.PbFieldType.KE,
        valueOf: UrpTokeCapability.valueOf,
        enumValues: UrpTokeCapability.values,
        defaultEnumValue: UrpTokeCapability.urpSig)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      ...
      'Will be removed in next major version')
  UrpToken copyWith(void Function(UrpToken) updates) =>
      super.copyWith((message) => updates(message as UrpToken)) as UrpToken;
  ...
  @$core.pragma('dart2js:noInline')
  static UrpToken getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<UrpToken>(create);
  static UrpToken? _defaultInstance;

  /// A 4-byte timestamp, representing the ObjectId's creation, measured in seconds since the Unix epoch.
  /// A 5-byte random value generated once per process. This random value is unique to the machine and process.
  /// A 3-byte incrementing counter, initialized to a random value.
  /// according to mongodb ids
  @$pb.TagNumber(1)
  ...
  /// used to install and report
  @$pb.TagNumber(2)
  $core.int get active => $_getIZ(1);
  @$pb.TagNumber(2)
  set active($core.int v) {
    $_setSignedInt32(1, v);
  }
  ...
  /// only used to request new
  @$pb.TagNumber(5)
  $core.int get request => $_getIZ(4);
  @$pb.TagNumber(5)
  set request($core.int v) {
    $_setSignedInt32(4, v);
  }
  ...
  @$pb.TagNumber(7)
  $core.List<UrpTokeCapability> get capabilities => $_getList(6);
}
...
class UrpSecureToken extends $pb.GeneratedMessage {
  ...
  factory UrpSecureToken.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory UrpSecureToken.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'UrpSecureToken',
      createEmptyInstance: create)
    ..aOM<UrpToken>(1, _omitFieldNames ? '' : 'token',
        subBuilder: UrpToken.create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  UrpSecureToken copyWith(void Function(UrpSecureToken) updates) =>
      super.copyWith((message) => updates(message as UrpSecureToken))
          as UrpSecureToken;
  ...
  static $pb.PbList<UrpSecureToken> createRepeated() =>
      $pb.PbList<UrpSecureToken>();
  @$core.pragma('dart2js:noInline')
  static UrpSecureToken getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<UrpSecureToken>(create);
  static UrpSecureToken? _defaultInstance;

  @$pb.TagNumber(1)
  UrpToken get token => $_getN(0);
  @$pb.TagNumber(1)
  set token(UrpToken v) {
    setField(1, v);
  }
...
class UrpTokenRequest extends $pb.GeneratedMessage {
  factory UrpTokenRequest({
    $core.int? amount,
    $core.Iterable<UrpTokeCapability>? requestedCapabilities,
  }) {
    final $result = create();
    if (amount != null) {
  ...
  factory UrpTokenRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory UrpTokenRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'UrpTokenRequest',
      createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'amount', $pb.PbFieldType.O3)
    ..pc<UrpTokeCapability>(
        2, _omitFieldNames ? '' : 'requestedCapabilities', $pb.PbFieldType.KE,
        protoName: 'requestedCapabilities',
        valueOf: UrpTokeCapability.valueOf,
        enumValues: UrpTokeCapability.values,
        defaultEnumValue: UrpTokeCapability.urpSig)
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  UrpTokenRequest copyWith(void Function(UrpTokenRequest) updates) =>
      super.copyWith((message) => updates(message as UrpTokenRequest))
          as UrpTokenRequest;
  ...
  static $pb.PbList<UrpTokenRequest> createRepeated() =>
      $pb.PbList<UrpTokenRequest>();
  @$core.pragma('dart2js:noInline')
  static UrpTokenRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<UrpTokenRequest>(create);
  ...
  /// capabilities the SDK is requesting; backend decides whether to grant them
  @$pb.TagNumber(2)
  $core.List<UrpTokeCapability> get requestedCapabilities => $_getList(1);
}
