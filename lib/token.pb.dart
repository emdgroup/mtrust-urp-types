...
class UrpToken extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UrpToken', createEmptyInstance: create)
    ...
    ..pc<UrpTokeCapability>(7, _omitFieldNames ? '' : 'capabilities', $pb.PbFieldType.KE, valueOf: UrpTokeCapability.valueOf, enumValues: UrpTokeCapability.values, defaultEnumValue: UrpTokeCapability.urpSig)
...
class UrpTokenRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UrpTokenRequest', createEmptyInstance: create)
    ...
    ..pc<UrpTokeCapability>(2, _omitFieldNames ? '' : 'requestedCapabilities', $pb.PbFieldType.KE, protoName: 'requestedCapabilities', valueOf: UrpTokeCapability.valueOf, enumValues: UrpTokeCapability.values, defaultEnumValue: UrpTokeCapability.urpSig)
    ..hasRequiredFields = false
  ;
