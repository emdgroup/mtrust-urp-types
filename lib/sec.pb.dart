...
class UrpSecDeviceCommand extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UrpSecDeviceCommand', createEmptyInstance: create)
    ...
    ..aOM<UrpSecSecureCalibrationRequest>(5, _omitFieldNames ? '' : 'calibrationRequest', protoName: 'calibrationRequest', subBuilder: UrpSecSecureCalibrationRequest.create)
  ...
  @$pb.TagNumber(5)
  set calibrationRequest(UrpSecSecureCalibrationRequest v) { setField(5, v); }
  @$pb.TagNumber(5)
...
class UrpSecCountsResponse extends $pb.GeneratedMessage {
  ...
  factory UrpSecCountsResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory UrpSecCountsResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UrpSecCountsResponse', createEmptyInstance: create)
    ...
    ..aOM<$1.UrpCalibration>(4, _omitFieldNames ? '' : 'calibration', subBuilder: $1.UrpCalibration.create)
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  UrpSecCountsResponse clone() => UrpSecCountsResponse()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UrpSecCountsResponse copyWith(void Function(UrpSecCountsResponse) updates) => super.copyWith((message) => updates(message as UrpSecCountsResponse)) as UrpSecCountsResponse;
  ...
  static $pb.PbList<UrpSecCountsResponse> createRepeated() => $pb.PbList<UrpSecCountsResponse>();
  @$core.pragma('dart2js:noInline')
  static UrpSecCountsResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<UrpSecCountsResponse>(create);
  ...
  @$pb.TagNumber(4)
  set calibration($1.UrpCalibration v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set counts($core.double v) { $_setFloat(4, v); }
  @$pb.TagNumber(5)
...
class UrpSecCalibrationRequest extends $pb.GeneratedMessage {
  ...
  factory UrpSecCalibrationRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory UrpSecCalibrationRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UrpSecCalibrationRequest', createEmptyInstance: create)
    ..a<$core.double>(1, _omitFieldNames ? '' : 'targetOc', $pb.PbFieldType.OF, protoName: 'targetOc')
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  UrpSecCalibrationRequest clone() => UrpSecCalibrationRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UrpSecCalibrationRequest copyWith(void Function(UrpSecCalibrationRequest) updates) => super.copyWith((message) => updates(message as UrpSecCalibrationRequest)) as UrpSecCalibrationRequest;
  ...
  static $pb.PbList<UrpSecCalibrationRequest> createRepeated() => $pb.PbList<UrpSecCalibrationRequest>();
  @$core.pragma('dart2js:noInline')
  static UrpSecCalibrationRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<UrpSecCalibrationRequest>(create);
  static UrpSecCalibrationRequest? _defaultInstance;

  @$pb.TagNumber(1)
  $core.double get targetOc => $_getN(0);
  @$pb.TagNumber(1)
  set targetOc($core.double v) { $_setFloat(0, v); }
  @$pb.TagNumber(1)
...
class UrpSecSecureCalibrationRequest extends $pb.GeneratedMessage {
  ...
  factory UrpSecSecureCalibrationRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory UrpSecSecureCalibrationRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UrpSecSecureCalibrationRequest', createEmptyInstance: create)
    ..aOM<UrpSecCalibrationRequest>(1, _omitFieldNames ? '' : 'request', subBuilder: UrpSecCalibrationRequest.create)
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  UrpSecSecureCalibrationRequest clone() => UrpSecSecureCalibrationRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UrpSecSecureCalibrationRequest copyWith(void Function(UrpSecSecureCalibrationRequest) updates) => super.copyWith((message) => updates(message as UrpSecSecureCalibrationRequest)) as UrpSecSecureCalibrationRequest;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static UrpSecSecureCalibrationRequest create() => UrpSecSecureCalibrationRequest._();
  UrpSecSecureCalibrationRequest createEmptyInstance() => create();
  static $pb.PbList<UrpSecSecureCalibrationRequest> createRepeated() => $pb.PbList<UrpSecSecureCalibrationRequest>();
  @$core.pragma('dart2js:noInline')
  static UrpSecSecureCalibrationRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<UrpSecSecureCalibrationRequest>(create);
  static UrpSecSecureCalibrationRequest? _defaultInstance;

  @$pb.TagNumber(1)
  UrpSecCalibrationRequest get request => $_getN(0);
  @$pb.TagNumber(1)
  set request(UrpSecCalibrationRequest v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class UrpSecSecureCountsResponse extends $pb.GeneratedMessage {
  ...
  factory UrpSecSecureCountsResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory UrpSecSecureCountsResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UrpSecSecureCountsResponse', createEmptyInstance: create)
    ..a<$core.List<$core.int>>(1, _omitFieldNames ? '' : 'signature', $pb.PbFieldType.OY)
    ..aOM<UrpSecCountsResponse>(2, _omitFieldNames ? '' : 'counts', subBuilder: UrpSecCountsResponse.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  UrpSecSecureCountsResponse clone() => UrpSecSecureCountsResponse()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UrpSecSecureCountsResponse copyWith(void Function(UrpSecSecureCountsResponse) updates) => super.copyWith((message) => updates(message as UrpSecSecureCountsResponse)) as UrpSecSecureCountsResponse;
  ...
  static $pb.PbList<UrpSecSecureCountsResponse> createRepeated() => $pb.PbList<UrpSecSecureCountsResponse>();
  @$core.pragma('dart2js:noInline')
  static UrpSecSecureCountsResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<UrpSecSecureCountsResponse>(create);
  ...
  @$pb.TagNumber(2)
  set counts(UrpSecCountsResponse v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class UrpSecMeasurement extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UrpSecMeasurement', createEmptyInstance: create)
    ...
    ..aInt64(8, _omitFieldNames ? '' : 'tokenIat', protoName: 'tokenIat')
    ..aInt64(9, _omitFieldNames ? '' : 'tokenExp', protoName: 'tokenExp')
    ..a<$core.double>(10, _omitFieldNames ? '' : 'temperature', $pb.PbFieldType.OF)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  set sensorVersion($core.String v) { $_setString(3, v); }
  @$pb.TagNumber(4)
...
class UrpSecRawMeasurement extends $pb.GeneratedMessage {
  ...
  factory UrpSecRawMeasurement.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory UrpSecRawMeasurement.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UrpSecRawMeasurement', createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'readerSn', protoName: 'readerSn')
    ..aOS(2, _omitFieldNames ? '' : 'sensorId', protoName: 'sensorId')
    ..aOS(3, _omitFieldNames ? '' : 'payload')
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  UrpSecRawMeasurement clone() => UrpSecRawMeasurement()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UrpSecRawMeasurement copyWith(void Function(UrpSecRawMeasurement) updates) => super.copyWith((message) => updates(message as UrpSecRawMeasurement)) as UrpSecRawMeasurement;
  ...
  static $pb.PbList<UrpSecRawMeasurement> createRepeated() => $pb.PbList<UrpSecRawMeasurement>();
  @$core.pragma('dart2js:noInline')
  static UrpSecRawMeasurement getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<UrpSecRawMeasurement>(create);
  ...
  @$pb.TagNumber(6)
  set sensorVersion($core.String v) { $_setString(5, v); }
  @$pb.TagNumber(6)
