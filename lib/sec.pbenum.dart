...
class UrpSecCommand extends $pb.ProtobufEnum {
  ...
  static const UrpSecCommand urpSecMeasureRaw = UrpSecCommand._(5, _omitEnumNames ? '' : 'urpSecMeasureRaw');
  ...
  static const UrpSecCommand urpSecGetCounts = UrpSecCommand._(9, _omitEnumNames ? '' : 'urpSecGetCounts');
  static const UrpSecCommand urpSecCalibrate = UrpSecCommand._(10, _omitEnumNames ? '' : 'urpSecCalibrate');
