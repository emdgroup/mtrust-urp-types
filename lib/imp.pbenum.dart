...
class UrpImpCommand extends $pb.ProtobufEnum {
  ...
  static const UrpImpCommand urpImpRequestToken = UrpImpCommand._(4, _omitEnumNames ? '' : 'urpImpRequestToken');
  static const UrpImpCommand urpImpSetToken = UrpImpCommand._(5, _omitEnumNames ? '' : 'urpImpSetToken');
  static const UrpImpCommand urpImpGetToken = UrpImpCommand._(6, _omitEnumNames ? '' : 'urpImpGetToken');
