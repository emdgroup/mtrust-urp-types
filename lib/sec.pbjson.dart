...
final $typed_data.Uint8List urpSecPrimeResponseDescriptor = $convert
    .base64Decode('ChNVcnBTZWNQcmltZVJlc3BvbnNlEhAKA2dzYRgBIAEoBVIDZ3Nh');
...
final $typed_data.Uint8List urpSecCalibrationRequestDescriptor =
...
final $typed_data.Uint8List urpSecSecureCalibrationRequestDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List urpSecSecureCountsResponseDescriptor =
    $convert.base64Decode(
...
const UrpSecMeasurementResult$json = {
  ...
  '2': [
    ...
    {
      '1': 'orthogonalDistance',
      '3': 3,
      '4': 1,
      '5': 2,
      '10': 'orthogonalDistance'
    },
    {
      '1': 'modelVersion',
      '3': 4,
