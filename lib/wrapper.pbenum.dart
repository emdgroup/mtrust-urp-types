...
class UrpDeviceType extends $pb.ProtobufEnum {
  ...
  static const UrpDeviceType urpTsc = UrpDeviceType._(8, _omitEnumNames ? '' : 'urpTsc');
...
class UrpErrorCode extends $pb.ProtobufEnum {
  static const UrpErrorCode urpNoError = UrpErrorCode._(0, _omitEnumNames ? '' : 'urpNoError');
  static const UrpErrorCode urpCustomError = UrpErrorCode._(1, _omitEnumNames ? '' : 'urpCustomError');
  static const UrpErrorCode urpDeprecatedError = UrpErrorCode._(2, _omitEnumNames ? '' : 'urpDeprecatedError');
  static const UrpErrorCode urpNotImplementedError = UrpErrorCode._(3, _omitEnumNames ? '' : 'urpNotImplementedError');
  static const UrpErrorCode urpLeaseError = UrpErrorCode._(4, _omitEnumNames ? '' : 'urpLeaseError');
  static const UrpErrorCode urpUserFacingError = UrpErrorCode._(5, _omitEnumNames ? '' : 'urpUserFacingError');
  static const UrpErrorCode urpTimeoutError = UrpErrorCode._(6, _omitEnumNames ? '' : 'urpTimeoutError');
  static const UrpErrorCode urpDeviceStateError = UrpErrorCode._(7, _omitEnumNames ? '' : 'urpDeviceStateError');
  static const UrpErrorCode urpPayloadError = UrpErrorCode._(8, _omitEnumNames ? '' : 'urpPayloadError');
  static const UrpErrorCode urpSensorError = UrpErrorCode._(9, _omitEnumNames ? '' : 'urpSensorError');
  static const UrpErrorCode urpCustomWarning = UrpErrorCode._(10, _omitEnumNames ? '' : 'urpCustomWarning');
  ...
  static final $core.Map<$core.int, UrpErrorCode> _byValue = $pb.ProtobufEnum.initByValue(values);
...
class UrpCommand extends $pb.ProtobufEnum {
  ...
  static const UrpCommand urpLog = UrpCommand._(20, _omitEnumNames ? '' : 'urpLog');
  static const UrpCommand urpEvent = UrpCommand._(21, _omitEnumNames ? '' : 'urpEvent');
  static const UrpCommand urpGetVersion = UrpCommand._(22, _omitEnumNames ? '' : 'urpGetVersion');
  static const UrpCommand urpGetConfig = UrpCommand._(23, _omitEnumNames ? '' : 'urpGetConfig');
  static const UrpCommand urpSetConfig = UrpCommand._(24, _omitEnumNames ? '' : 'urpSetConfig');
  static const UrpCommand urpResetConfig = UrpCommand._(25, _omitEnumNames ? '' : 'urpResetConfig');
  static const UrpCommand urpSignChallenge = UrpCommand._(26, _omitEnumNames ? '' : 'urpSignChallenge');
...
class UrpEventType extends $pb.ProtobufEnum {
  static const UrpEventType urpBtnPressed = UrpEventType._(0, _omitEnumNames ? '' : 'urpBtnPressed');
  static const UrpEventType urpBtnReleased = UrpEventType._(1, _omitEnumNames ? '' : 'urpBtnReleased');
  static const UrpEventType urpBtnLongpressed = UrpEventType._(2, _omitEnumNames ? '' : 'urpBtnLongpressed');
  ...
  static final $core.Map<$core.int, UrpEventType> _byValue = $pb.ProtobufEnum.initByValue(values);
...
class UrpButtonMode extends $pb.ProtobufEnum {
  static const UrpButtonMode urpButtonToggle = UrpButtonMode._(0, _omitEnumNames ? '' : 'urpButtonToggle');
  static const UrpButtonMode urpButtonMomentary = UrpButtonMode._(1, _omitEnumNames ? '' : 'urpButtonMomentary');
  static const UrpButtonMode urpButtonDisabled = UrpButtonMode._(2, _omitEnumNames ? '' : 'urpButtonDisabled');
  ...
  static final $core.Map<$core.int, UrpButtonMode> _byValue = $pb.ProtobufEnum.initByValue(values);
