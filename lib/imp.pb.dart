...
class UrpImpMeasurement extends $pb.GeneratedMessage {
  factory UrpImpMeasurement({
    ...
    if (tokenConsumption != null) {
      $result.tokenConsumption = tokenConsumption;
    }
    return $result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UrpImpMeasurement', createEmptyInstance: create)
    ...
    ..a<$core.int>(7, _omitFieldNames ? '' : 'tokenConsumption', $pb.PbFieldType.OU3, protoName: 'tokenConsumption')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(7)
  $core.int get tokenConsumption => $_getIZ(6);
  @$pb.TagNumber(7)
  set tokenConsumption($core.int v) { $_setUnsignedInt32(6, v); }
  @$pb.TagNumber(7)
  $core.bool hasTokenConsumption() => $_has(6);
  @$pb.TagNumber(7)
  void clearTokenConsumption() => clearField(7);
}
